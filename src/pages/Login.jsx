...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_right,#d9eee7_0%,transparent_34%),linear-gradient(135deg,#fffaf2_0%,#faf7f2_44%,#edf7f2_100%)] flex items-center justify-center px-6 py-10 sm:px-8 sm:py-16 relative overflow-hidden">
