...
const navItems = [
  ...
  { to: '/chat',    icon: '🤖', label: 'AI Companion'   },
  { to: '/report',  icon: '📊', label: 'Wellness Report'},
  { to: '/clinics', icon: '🏥', label: 'Find Clinics'   },
]
  ...
  return (
    <aside className="w-60 bg-navy min-h-screen fixed top-0 left-0 flex flex-col z-50 overflow-hidden">
      ...
      <div className="px-6 pt-7 pb-5 border-b border-white/5">
        <span className="block text-teal-light text-2xl font-serif tracking-wide">Nirvana</span>
        <span className="block text-xs text-teal-light/40 mt-1 tracking-widest uppercase">Wellness</span>
      </div>
      ...
      <div className="mx-3 mt-4 flex items-center gap-3 bg-white/4 border border-white/5 rounded-xl px-4 py-3">
        ...
        <div className="overflow-hidden">
          ...
          <div className="text-xs text-teal-light/60">✦ Wellness member</div>
        </div>
      </div>

      {/* Navigation */}
      <nav className="flex-1 px-3 py-4 overflow-y-auto">
        <div className="text-[10px] uppercase tracking-widest text-white/20 px-3 mb-2">Main</div>
        ...
        <div className="text-[10px] uppercase tracking-widest text-white/20 px-3 mb-2 mt-4">AI Features</div>
        ...
        <div className="text-[10px] uppercase tracking-widest text-white/20 px-3 mb-2 mt-4">Help</div>
